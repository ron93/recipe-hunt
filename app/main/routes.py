...
from app.main.forms import EditProfileForm, EmptyForm, RecipeForm, SearchForm, \
    MessageForm
from app.models import User, Recipe, Message, Notification
...
def index():
    ...
    if form.validate_on_submit():
        ...
        if language == 'UNKNOWN' or len(language) > 5:
            language = ''
        recipe = Recipe(name=form.name.data, ingredients=form.ingredients.data, steps=form.steps.data, author=current_user,
                    language=language)
